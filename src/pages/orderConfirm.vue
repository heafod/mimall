<template>
  <div class="order-confirm">
    ...
    <modal
      ...
      @submit="submitAddress"
    >
      <template v-slot:body>你确定要删除这个地址吗?</template>
    </modal>
  </div>
</template>
<script>
  ...
  methods: {
    ...
    getCartList() {
      this.axios.get("/carts").then(res => {
        let cartProductList = res.cartProductVoList;
        this.cartTotalPrice = res.cartTotalPrice;
        this.cartList = cartProductList.filter(item => item.productSelected);
